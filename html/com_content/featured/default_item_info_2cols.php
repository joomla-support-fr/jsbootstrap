 ...
 * --------------------------------------------------------------------------------------
 * actualisé par lomart le 6/10/12 por JSBootstrap : version avec info sur 2 colonnes
 */
...
<div class="badge badge-success">com_content\featured\default_item.php</div>
...
<div class="system-unpublished">
	...
	<div class="row-fluid article-info">
		<div class="span8 article-info-left">
			...
			<!-- date crea, modif, publié, nb view -->
		...
		<div class="span4 article-info-right">
			<!-- Item Actions -->
